...
class clsHeader2 { //Header2 class @1-88C4A843
...
//Class_Initialize Event @1-8E418B2F
    function clsHeader2()
    {
        $this->Visible = true;
        if($this->Visible)
        {
            $this->FileName = "Header2.php";
            $this->Redirect = "";
            $this->TemplateFileName = "Header2.html";
